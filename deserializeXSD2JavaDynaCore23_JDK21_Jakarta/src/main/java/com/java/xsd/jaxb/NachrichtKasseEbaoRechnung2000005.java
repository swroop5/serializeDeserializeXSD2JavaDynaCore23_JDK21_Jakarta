 ...
 *                   &lt;element name="zahlungsbestimmungen" type="{http://www.xjustiz.de}Type.KASSE.Zahlungsbestimmungen" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "nachricht.kasse.ebao-rechnung.2000005")
public class NachrichtKasseEbaoRechnung2000005 {
    ...
    @XmlElement(required = true)
    protected NachrichtKasseEbaoRechnung2000005 .Fachdaten fachdaten;
     ...
     * @return
     *     possible object is
     *     {@link NachrichtKasseEbaoRechnung2000005 .Fachdaten }
     *     
     */
    public NachrichtKasseEbaoRechnung2000005 .Fachdaten getFachdaten() {
        return fachdaten;
    }
     ...
     *     
     */
    public void setFachdaten(NachrichtKasseEbaoRechnung2000005 .Fachdaten value) {
