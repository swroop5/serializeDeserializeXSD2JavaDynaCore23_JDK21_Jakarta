 ...
 *         &lt;element name="fachdaten" type="{http://www.xjustiz.de}Type.VAG.Kurzmitteilung"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "nachricht.vag.kurzmitteilung.gerichtZuVersorgungstraeger.0250007")
public class NachrichtVagKurzmitteilungGerichtZuVersorgungstraeger0250007 {
    ...
    @XmlElement(required = true)
    protected TypeVAGKurzmitteilung fachdaten;
     ...
     * @return
     *     possible object is
     *     {@link TypeVAGKurzmitteilung }
     *     
     */
    public TypeVAGKurzmitteilung getFachdaten() {
        return fachdaten;
    }
     ...
     *     
     */
    public void setFachdaten(TypeVAGKurzmitteilung value) {
