 ...
 *         &lt;element name="fachdaten" type="{http://www.xjustiz.de}Type.EHUG.Fachdaten"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "nachricht.ehug.uebergabe.2100001")
public class NachrichtEhugUebergabe2100001 {
    ...
    @XmlElement(required = true)
    protected TypeEHUGFachdaten fachdaten;
     ...
     * @return
     *     possible object is
     *     {@link TypeEHUGFachdaten }
     *     
     */
    public TypeEHUGFachdaten getFachdaten() {
        return fachdaten;
    }
     ...
     *     
     */
    public void setFachdaten(TypeEHUGFachdaten value) {
