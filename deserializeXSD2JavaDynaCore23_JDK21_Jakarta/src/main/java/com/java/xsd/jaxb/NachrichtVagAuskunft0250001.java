 ...
 *         &lt;element name="fachdaten" type="{http://www.xjustiz.de}Type.VAG.Auskunft"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "nachricht.vag.auskunft.0250001")
public class NachrichtVagAuskunft0250001 {
    ...
    @XmlElement(required = true)
    protected TypeVAGAuskunft fachdaten;
     ...
     * @return
     *     possible object is
     *     {@link TypeVAGAuskunft }
     *     
     */
    public TypeVAGAuskunft getFachdaten() {
        return fachdaten;
    }
     ...
     *     
     */
    public void setFachdaten(TypeVAGAuskunft value) {
