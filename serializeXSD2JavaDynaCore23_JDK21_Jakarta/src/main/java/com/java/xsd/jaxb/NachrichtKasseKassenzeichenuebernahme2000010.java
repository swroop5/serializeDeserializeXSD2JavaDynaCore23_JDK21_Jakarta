 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="zuUebernehmendesKassenzeichen" type="{urn:xoev-de:kosit:xoev:datentyp:din-spec-91379_2019-03}datatypeC"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlRootElement(name = "nachricht.kasse.kassenzeichenuebernahme.2000010")
public class NachrichtKasseKassenzeichenuebernahme2000010 {
    ...
    @XmlElement(required = true)
    protected NachrichtKasseKassenzeichenuebernahme2000010 .Fachdaten fachdaten;
     ...
     * @return
     *     possible object is
     *     {@link NachrichtKasseKassenzeichenuebernahme2000010 .Fachdaten }
     *     
     */
    public NachrichtKasseKassenzeichenuebernahme2000010 .Fachdaten getFachdaten() {
        return fachdaten;
    }
     ...
     *     
     */
    public void setFachdaten(NachrichtKasseKassenzeichenuebernahme2000010 .Fachdaten value) {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = {
        "zuUebernehmendesKassenzeichen"
    })
    public static class Fachdaten {

        @XmlElement(required = true)
        protected String zuUebernehmendesKassenzeichen;

        /**
         * Gets the value of the zuUebernehmendesKassenzeichen property.
         * 
         * @return
         *     possible object is
         *     {@link String }
         *     
         */
        public String getZuUebernehmendesKassenzeichen() {
            return zuUebernehmendesKassenzeichen;
        }

        /**
         * Sets the value of the zuUebernehmendesKassenzeichen property.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setZuUebernehmendesKassenzeichen(String value) {
            this.zuUebernehmendesKassenzeichen = value;
        }
